...
impl Producer {
    ...
    pub(crate) fn free(&self, want: u32) -> u32 {
    ...
    pub(crate) fn claim(&self, size: u32) -> (u32, u32) {
        let mut index = 0;
    ...
    pub(crate) fn write_fill_address(&self, index: u32, address: u64) {
    ...
    pub(crate) fn commit(&self, offset: u32) {
...
impl Consumer {
    ...
    pub(crate) fn read_completion_address(&self, index: u32) -> u64 {
